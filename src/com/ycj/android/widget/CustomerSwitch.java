package com.ycj.android.widget;
...
public class CustomerSwitch extends CompoundButton {
    ...
    /**
     * 构造函数
     * Construct a new CustomerSwitch with default styling.
     * @param context
     */
	...
	/**
	 * Construct a new CustomerSwitch with default styling, overriding specific style
	 * attributes as requested.
	 * @param context
	 * @param attrs
	 */
	public CustomerSwitch(Context context, AttributeSet attrs) {
		this(context, attrs,R.attr.customerSwitchStyleAttr);
	}
	/**
	 * Construct a new CustomerSwitch with a default style determined by the given theme attribute,
	 * overriding specific style attributes as requested.
	 * @param context
	 * @param attrs
	 * @param defStyle
	 */
	public CustomerSwitch(Context context, AttributeSet attrs, int defStyle){
		super(context, attrs, defStyle);
		 mTextPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
	        ...
	        TypedArray a = context.obtainStyledAttributes(attrs,
	                R.styleable.CustomerSwitch, defStyle, 0);

	        mLeftBackground = a.getDrawable(R.styleable.CustomerSwitch_leftBackground);
	        //if (mLeftBackground == null) {
	        	//mLeftBackground = new ColorDrawable(0xFF11BB33);
	        //}
	        mRightBackground = a.getDrawable(R.styleable.CustomerSwitch_rightBackground);
	        //if (mRightBackground == null) {
	        	//mRightBackground = new ColorDrawable(0x993322BB);
	        //}
	        
	        mOrientation = a.getInteger(R.styleable.CustomerSwitch_orientation, HORIZONTAL);
	        //Log.d(TAG, "mLeftBackground="+mLeftBackground);
	        //Log.d(TAG, "mRightBackground="+mRightBackground);
	        mThumbDrawable = a.getDrawable(R.styleable.CustomerSwitch_thumb);
	        mTrackDrawable = a.getDrawable(R.styleable.CustomerSwitch_track);
	        mTextOn = a.getText(R.styleable.CustomerSwitch_textOn);
	        mTextOff = a.getText(R.styleable.CustomerSwitch_textOff);
	        mDrawableOn = a.getDrawable(R.styleable.CustomerSwitch_drawableOn);
	        mDrawableOff = a.getDrawable(R.styleable.CustomerSwitch_drawableOff);
	        mPushStyle = a.getBoolean(R.styleable.CustomerSwitch_pushStyle, false);
	        mTextOnThumb = a.getBoolean(R.styleable.CustomerSwitch_textOnThumb, false);
	        mThumbExtraMovement = a.getDimensionPixelSize(R.styleable.CustomerSwitch_thumbExtraMovement, 0);
	        mThumbTextPadding = a.getDimensionPixelSize( R.styleable.CustomerSwitch_thumbTextPadding, 0);
	        mTrackTextPadding = a.getDimensionPixelSize( R.styleable.CustomerSwitch_trackTextPadding, 0);
	        mSwitchMinWidth = a.getDimensionPixelSize( R.styleable.CustomerSwitch_switchMinWidth, 0);
	        mSwitchMinHeight = a.getDimensionPixelSize( R.styleable.CustomerSwitch_switchMinHeight, 0);
	        mSwitchPadding =  a.getDimensionPixelSize( R.styleable.CustomerSwitch_switchPadding, 0);
	        ...
	        mMaskDrawable = a.getDrawable(R.styleable.CustomerSwitch_backgroundMask);
	        ...
	        int appearance = a.getResourceId(R.styleable.CustomerSwitch_switchTextAppearanceAttrib, 0);
	        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TypedArray appearance =
                context.obtainStyledAttributes(resid, R.styleable.customerSwitchTextAppearanceAttrib);

        ColorStateList colors;
        int ts;

        colors = appearance.getColorStateList(R.styleable.customerSwitchTextAppearanceAttrib_textColor);
        if (colors != null) {
            mTextColors = colors;
        } else {
        ...
        ts = appearance.getDimensionPixelSize(R.styleable.customerSwitchTextAppearanceAttrib_textSize, 0);
        if (ts != 0) {
        ...
        typefaceIndex = appearance.getInt(R.styleable.customerSwitchTextAppearanceAttrib_typeface, -1);
        styleIndex = appearance.getInt(R.styleable.customerSwitchTextAppearanceAttrib_textStyle, -1);
